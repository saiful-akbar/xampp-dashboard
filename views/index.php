  ...
  <?php foreach ($projects as $project): ?>
		<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
			<div class="card shadow-sm">
			  <a href="<?= e($project->url); ?>" target="_blank" class="project">
				  <div class="card-body">
			  ...
			  <footer class="card-footer">
					<button
						type="button"
						onclick="handleDelete('<?= e(route('home/delete', ['id' => $project->id])); ?>')"
						class="btn btn-sm btn-secondary bg-gradient shadow-sm"
					...
					<a
						href="<?= e(route('home/edit', ['id' => $project->id])); ?>"
						class="btn btn-sm btn-secondary bg-gradient shadow-sm ms-2"
						role="button"
						data-bs-toggle="tooltip"
						title="Edit"
					>
