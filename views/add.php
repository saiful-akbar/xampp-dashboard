        ...
        <div class="card-body">
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-8 col-sm-12">
              <input type="text" name="name" id="name" class="form-control <?= !empty(errors('name')) ? 'is-invalid' : '' ?>" value="<?= e(old('name')) ?>" placeholder="Enter project name..." required />
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-8 col-sm-12">
              <input type="text" name="url" id="url" class="form-control <?= !empty(errors('url')) ? 'is-invalid' : '' ?>" value="<?= e(old('url')) ?>" placeholder="Enter project url..." required />
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-8 col-sm-12">
              <textarea name="description" id="description" class="form-control <?= !empty(errors('description')) ? 'is-invalid' : '' ?>" rows="5" placeholder="Enter project description..."><?= e(old('description')) ?></textarea>
